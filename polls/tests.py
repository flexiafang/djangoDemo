...
def create_question(question_text, days=0):
    ...
    :param question_text: The question's text.
    :param days: Negative for questions published in the past, positive for questions that have yet to be published.
    """
...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        """
        `was_published_recently()` returns False for question whose pub_date is in hte future.
        """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_no_question(self):
        """
        If no question exist, an appropriate message is display.
        """
